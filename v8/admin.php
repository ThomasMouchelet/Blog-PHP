			        ...
			        <tbody>
		                ...
		                ?>
		               	<tr>
		                    ...
		                    <th data-field="id"><a href="edit_billet.php?billet=<?php echo $donnees['id']; ?>" class="waves-effect waves-light btn-large">Modifier</a></th>
		                    <th data-field="id">
                            <a href="delete_billet.php?billet=<?php echo $donnees['id']; ?>" class="waves-effect waves-light btn-large">Supprimer</a></th>
		                </tr>   
		                <?php
